window.__unlighthouse_payload = {
  ...
  options: {
      ...
      columns: {
        ...
        performance: [
          ...
          },
          {
            ...
            warning: true,
            tooltip:
              'Warning: This is deprecated in favour if INP which is not yet supported by Unlighthouse. The maximum potential First Input Delay that your users could experience is the duration of the longest task. [Learn more](https://web.dev/lighthouse-max-potential-fid/).',
            sortKey: 'numericValue',
    ...
    site: 'https://ibrahimhassen.netlify.app',
